    ...
    <div className="page-body">
      <div style={{display: 'flex', gap: '2rem'}}>
        <div style={{flex: 1}}>
          ...
          <div className="filter-tabs" style={{display: 'flex', gap: '1rem', marginBottom: '1.5rem', borderBottom: '1px solid var(--border)', paddingBottom: '0.5rem'}}>
            {[{value: 'all', label: 'All Models'}, ...MODELS].map(f => (
              <button 
                ...
                style={{
                  ...
                  fontSize: '0.75rem', fontWeight: 700, cursor: 'pointer', padding: '0.5rem 0',
